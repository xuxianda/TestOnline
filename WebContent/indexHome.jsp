...
<body>
	<div id="wrapper">
		<div id="page-wrapper" style="position: absolute; left: -250px;">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">后台管理页面</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
			<div class="row">
					...
					<div class="panel panel-primary">
											...
											$
													.ajax({
														...
														success : function(xx) {
															if (xx) {
																document
																		.getElementById("user").innerHTML = xx;
															}
														}
													});
										</script>
						...
						<a href="#">
							<div class="panel-footer">
								<span class="pull-left">管理用户</span> <span class="pull-right"><i
				...
				<div class="col-lg-3 col-md-6">
					<div class="panel panel-green">
											...
											$
													.ajax({
														...
														success : function(xx) {
															console.log(xx);
															document
																	.getElementById("paper").innerHTML = xx;
														}
													});
										</script>
									</div>
						...
						<a href="#">
							<div class="panel-footer">
								<span class="pull-left">前去阅卷</span> <span class="pull-right"><i
									class="fa fa-arrow-circle-right"></i></span>
								<div class="clearfix"></div>
							</div>
						</a>
				...
				<div class="col-lg-3 col-md-6">
					<div class="panel panel-yellow">
						...
						<a href="#">
							<div class="panel-footer">
								<span class="pull-left">前去查询</span> <span class="pull-right"><i
									class="fa fa-arrow-circle-right"></i></span>
								<div class="clearfix"></div>
							</div>
						</a>
										...
										<script type="text/javascript">
											$
													.ajax({
														...
														success : function(xx) {
															document
																	.getElementById("test").innerHTML = xx;
														}
													});
										</script>
									</div>
			...
			<div class="row">
				<div class="col-lg-8">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<i class="fa fa-bar-chart-o fa-fw"></i>考试数据
							<div class="pull-right">
								<div class="btn-group">
									<button type="button"
										class="btn btn-default btn-xs dropdown-toggle"
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<i class="fa fa-clock-o fa-fw"></i>事件
						</div>
						<!-- /.panel-heading -->
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-4">
									<div class="div-table">
										<ul class="div-ul">
											<li id="userstate0" class="div-td"><script>
												$
														.ajax({
															url : 'stu/ustate',
															type : 'get',
															success : function(
																	xx) {
																document
																		.getElementById("userstate0").innerHTML = "未审核的用户目前有"
																		+ xx
																		+ "个";
															}
														});
										...
										<ul class="div-ul">
											<li id="paperstae0" class="div-td"><script>
												$
														.ajax({
															url : 'stu/testPaper',
															method : 'get',
															success : function(
																...
																console.log(xx);
																document
																		.getElementById("paperstae0").innerHTML = "未审核的试卷目前有"
																		+ xx
																		+ "份";
															}
														});
										...
										<div class="timeline-panel">
											...
											<div class="timeline-body">
												<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Autem dolorem quibusdam, tenetur commodi
													...
													alias, officia repellendus.</p>
												<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laudantium maiores odit qui est tempora eos,
				...
				<div class="col-lg-4">
					<div class="panel panel-default">
						<div class="panel-heading">
							<i class="fa fa-bell fa-fw"></i> 处理事项
						</div>
						<!-- /.panel-heading -->
						<div class="panel-body">
							<div class="list-group">
								<a href="#" class="list-group-item"> <i
									class="fa fa-comment fa-fw"></i> 新的消息 <span
									class="pull-right text-muted small"><em>1 分钟以前</em> </span>
								</a>
								...
								<a href="#" class="list-group-item"> <i
									class="fa fa-envelope fa-fw"></i> 收到的邮件 <span
									class="pull-right text-muted small"><em>27 分钟以前</em> </span>
								</a> <a href="#" class="list-group-item"> <i
									class="fa fa-tasks fa-fw"></i> 未阅卷数量 <span
									class="pull-right text-muted small"><em>43 分钟以前</em> </span>
								</a> <a href="#" class="list-group-item"> <i
									class="fa fa-upload fa-fw"></i> 服务器时间 <span
									class="pull-right text-muted small"><em>14:47</em> </span>
								</a>
								<!-- <a href="#" class="list-group-item">
							...
							<!-- /.list-group -->
							<a href="#" class="btn btn-default btn-block">查看所有视图</a>
						</div>
						<!-- /.panel-body -->
					</div>
					<!-- /.panel -->
					...
					<div class="chat-panel panel panel-default">
						...
						<div class="panel-body">
							<ul class="chat">
								...
								<li class="right clearfix">【大佬】小星星:什么什么什么？</li>

								<li class="right clearfix">【大佬】星小小:什么什么什么？</li>

								<li class="right clearfix">【大佬】小小星:什么什么什么？</li>

								<li class="right clearfix">【大佬】小星小:重要的事要说三遍！！！</li>
							</ul>
						</div>
						<!-- /.panel-body -->
						<div class="panel-footer">
				...
				$.ajax({
					...
					success: function(response) {
						...
						for (var i = obj.length - 1; i >= 0; i--) {
							$(".chat").append('<li class="right clearfix"><span>【' + obj[i].rname + '】' + obj[i].uname + '：</span>' + obj[
								i].message + '</li>');
							console.log(obj[i]);
						}
					},
